...
I am going ot use the R `prcomp` function for PCA of our counts data
(from which I have removed the zero count genes).
...
![](Class16_MiniProject_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](Class16_MiniProject_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](Class16_MiniProject_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](Class16_MiniProject_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
```
    ...
    ## Info: Working in directory /Users/Gabriellemeza/Desktop/UCSD/Bioinformatics/bggn213_github/Class16_Miniproject
...
Gene Ontology (GO) We can also do a similar procedure with gene
